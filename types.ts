...
export type View = 'home' | 'reglement' | 'participants' | 'events' | 'strecken' | 'standings' | 'settings' | 'eventDetail' | 'impressum' | 'teilnahmeerklaerung' | 'userLogin' | 'userRegister' | 'userProfile';
